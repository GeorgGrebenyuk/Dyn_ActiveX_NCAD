namespace DynNCXLib
{
    ...
    public class AcadDocument
    {
        ...
        /// <summary>
        /// Cast interfce nanoCAD.AcadDocument to that class. Use only with Custom Node ConnectToAcadDoc!!!
        /// </summary>
        /// <param name="AcadDocument_object"></param>
        [Autodesk.DesignScript.Runtime.IsVisibleInDynamoLibrary(false)]
        public AcadDocument(object AcadDocument_object)
        {
            this._i = AcadDocument_object as nanoCAD.Document;
        }
        ...
        public void Regen(nanoCAD.AcRegenType WhichViewports) => this._i.Regen((nanoCAD.AcRegenType)WhichViewports);
        ...
        /// </summary>
        public nanoCAD.AcActiveSpace ActiveSpace => this._i.ActiveSpace;

        /// <summary>
        /// Toggles the active space between paper space and model space
        /// </summary>
        /// <param name="ActiveSpace"></param>
        public void Set_ActiveSpace(nanoCAD.AcActiveSpace ActiveSpace) => this._i.ActiveSpace = ActiveSpace;
        ...
        /// </summary>
        public SelectionSet ActiveSelectionSet => new SelectionSet(this._i.ActiveSelectionSet);
