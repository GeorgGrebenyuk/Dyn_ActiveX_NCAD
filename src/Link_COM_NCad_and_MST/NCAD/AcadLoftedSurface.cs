namespace DynNCXLib 
{
	...
	{
		public OdaX.AcadLoftedSurface _i;
		internal AcadLoftedSurface(object AcadLoftedSurface_object) 
		{
			this._i = AcadLoftedSurface_object as OdaX.AcadLoftedSurface;
		...
		///
		///</summary>
		public void Set_SurfaceNormals(OdaX.AcLoftedSurfaceNormalType surfaceNormal) 
		{
