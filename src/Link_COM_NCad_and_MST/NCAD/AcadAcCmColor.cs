namespace DynNCXLib 
{
	...
	{
		public OdaX.AcadAcCmColor _i;
		internal AcadAcCmColor(object AcadAcCmColor_object) 
		{
			this._i = AcadAcCmColor_object as OdaX.AcadAcCmColor;
        ...
        ///</summary>
        public void Set_ColorMethod(OdaX.AcColorMethod Flags) 
		{
        ...
        ///Specifies the color index
        ///</summary>
        public void Set_ColorIndex(OdaX.AcColor color) 
		{
