...
namespace DynNCXLib 
{
	...
	{
		public OdaX.AcadHatch _i;
		internal AcadHatch(object AcadHatch_object) 
		{
			this._i = AcadHatch_object as OdaX.AcadHatch;
        ...
        {
            this._i = AcadEntity._i as OdaX.AcadHatch;
            if (this._i == null) throw new System.Exception("Invalid casting");
        }
		///<summary>
		/// Create new hatch object
		///</summary>
		public AcadHatch (dynamic AcadBlock, OdaX.AcPatternType PatternType, string PatternName, 
			bool Associativity, OdaX.AcHatchObjectType HatchObjectType)
		{
		...
		///
		///</summary>
		public OdaX.AcPatternType PatternType => this._i.PatternType;
		...
		///
		///</summary>
		public void Set_ISOPenWidth(OdaX.AcISOPenWidth penWidth) 
		{
		...
		///
		///</summary>
		public OdaX.AcHatchStyle HatchStyle => this._i.HatchStyle;

		///<summary>
		///
		///</summary>
		public void Set_HatchStyle(OdaX.AcHatchStyle HatchStyle) 
		{
		...
		///
		///</summary>
		public void InsertLoopAt(int Index,OdaX.AcLoopType LoopType, List<AcadEntity> ObjectArray) 
		{
		...
		///
		///</summary>
		public OdaX.AcHatchObjectType HatchObjectType => this._i.HatchObjectType;

		///<summary>
		///
		///</summary>
		public void Set_HatchObjectType(OdaX.AcHatchObjectType hatchType) 
		{
