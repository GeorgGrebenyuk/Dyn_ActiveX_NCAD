...
namespace DynNCXLib 
{
	...
	{
		public OdaX.AcadRasterImage _i;
		internal AcadRasterImage(object AcadRasterImage_object) 
		{
			this._i = AcadRasterImage_object as OdaX.AcadRasterImage;
        ...
        public AcadRasterImage (AcadBlock AcadBlock, string imageFileName, GeometryWrapper.Point InsertionPoint, double ScaleFactor, double RotationAngle)
        {
        ...
        {
            this._i = AcadEntity._i as OdaX.AcadRasterImage;
            if (this._i == null) throw new System.Exception("Invalid casting");
        }
