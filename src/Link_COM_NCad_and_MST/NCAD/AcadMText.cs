...
namespace DynNCXLib 
{
    ...
    public class AcadMText 
	{
		...
		{
			this._i = AcadMText_object as OdaX.AcadMText;
        ...
        {
            this._i = AcadEntity._i as OdaX.AcadMText;
            if (this._i == null) throw new System.Exception("Invalid casting");
        }
		...
		///
		///</summary>
		public void Set_AttachmentPoint(OdaX.AcAttachmentPoint attPoint) 
		{
		...
		///
		///</summary>
		public void Set_DrawingDirection(OdaX.AcDrawingDirection drawDir) 
		{
		...
		///
		///</summary>
		public void Set_LineSpacingStyle(OdaX.AcLineSpacingStyle style) 
		{
