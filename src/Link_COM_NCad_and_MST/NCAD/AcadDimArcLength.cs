...
namespace DynNCXLib 
{
	...
	{
		public OdaX.AcadDimArcLength _i;
		internal AcadDimArcLength(object AcadDimArcLength_object) 
		{
			this._i = AcadDimArcLength_object as OdaX.AcadDimArcLength;
        ...
        {
            this._i = AcadEntity._i as OdaX.AcadDimArcLength;
            if (this._i == null) throw new System.Exception("Invalid casting");
        }
  ...
  //      public bool AltUnits => this._i.AltUnits;
		...
		/////
		/////</summary>
		//public void Set_SymbolPosition(OdaX.AcDimArcLengthSymbol Position) 
		//{
