...
namespace DynNCXLib 
{
	...
	{
		public OdaX.AcadPViewport _i;
		internal AcadPViewport(object AcadPViewport_object) 
		{
			this._i = AcadPViewport_object as OdaX.AcadPViewport;
        ...
        {
			((nanoCAD.Document)acadLayout._i.Document).ActiveLayout = acadLayout._i;
		...
		///
		///</summary>
		public void Set_StandardScale(OdaX.AcViewportScale scale) 
		{
