...
namespace DynNCXLib 
{
	...
	{
		public OdaX.Acad3DPolyline _i;
		internal Acad3DPolyline(object Acad3DPolyline_object) 
		{
			this._i = Acad3DPolyline_object as OdaX.Acad3DPolyline;
        ...
        {
            this._i = AcadEntity._i as OdaX.Acad3DPolyline;
            if (this._i == null) throw new System.Exception("Invalid casting");
        }
        ///<summary>
        ...
        /// Specifies type of a Polyline object
        ///</summary>
        public void Set_Type(OdaX.Ac3DPolylineType Type) 
		{
			this._i.Type = Type;
		}
