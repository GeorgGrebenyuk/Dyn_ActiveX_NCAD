...
namespace DynNCXLib 
{
	...
	{
		public OdaX.AcadDim3PointAngular _i;
		internal AcadDim3PointAngular(object AcadDim3PointAngular_object) 
		{
			this._i = AcadDim3PointAngular_object as OdaX.AcadDim3PointAngular;
        ...
        {
            this._i = AcadEntity._i as OdaX.AcadDim3PointAngular;
            if (this._i == null) throw new System.Exception("Invalid casting");
        }
		...
		///
		///</summary>
		public void Set_TextPrecision(OdaX.AcDimPrecision AngleVertex) 
		{
