...
namespace DynNCXLib 
{
    ...
    public class AcadTable 
	{
		...
		///
		///</summary>
		public dynamic GetAlignment(OdaX.AcRowType rowType) 
		{
		...
		///
		///</summary>
		public dynamic GetBackgroundColor(OdaX.AcRowType rowType) 
		{
		...
		///
		///</summary>
		public dynamic GetContentColor(OdaX.AcRowType rowType) 
		{
		...
		///
		///</summary>
		public dynamic GetGridLineWeight(OdaX.AcGridLineType gridLineType,OdaX.AcRowType rowType) 
		{
		...
		///
		///</summary>
		public dynamic GetGridColor(OdaX.AcGridLineType gridLineType,OdaX.AcRowType rowType) 
		{
		...
		///
		///</summary>
		public dynamic GetCellGridLineWeight(int row,int col,OdaX.AcCellEdgeMask edge) 
		{
		...
		///
		///</summary>
		public dynamic GetCellGridColor(int row,int col,OdaX.AcCellEdgeMask edge) 
		{
		...
		///
		///</summary>
		public void SetFieldId2(int nRow,int nCol,int nContent,dynamic acDbObjectId,OdaX.AcCellOption nflag) 
		{
		...
		///
		///</summary>
		public dynamic GetGridLinetype(int nRow,int nCol,OdaX.AcGridLineType nGridLineType) 
		{
		...
		///
		///</summary>
		public void SetGridLinetype(int nRow,int nCol,OdaX.AcGridLineType nGridLineType,dynamic idLinetype) 
		{
		...
		///
		///</summary>
		public dynamic GetGridLineStyle(int nRow,int nCol,OdaX.AcGridLineType nGridLineType) 
		{
