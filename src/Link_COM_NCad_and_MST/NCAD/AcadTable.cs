...
namespace DynNCXLib 
{
    ...
    public class AcadTable 
	{
		...
		{
			this._i = AcadTable_object as OdaX.AcadTable;
        ...
        {
            this._i = AcadEntity._i as OdaX.AcadTable;
            if (this._i == null) throw new System.Exception("Invalid casting");
        }
		...
		//      ///
		//      ///</summary>
		//      public GeometryWrapper.Point InsertionPoint =>
		...
		/////
		/////</summary>
		//public void SetBackgroundColor(int rowTypes, AcadAcCmColor pColor) 
		//{
		//	this._i.SetBackgroundColor(rowTypes,pColor._i);
		//}

		/////<summary>
		/////
		/////</summary>
		//public AcadAcCmColor GetContentColor(OdaX.AcRowType rowType) 
		//{
		//	return new AcadAcCmColor(this._i.GetContentColor(rowType));
		//}

		/////<summary>
		/////
		/////</summary>
		//public void SetContentColor(int rowTypes, AcadAcCmColor pColor) 
		//{
		//	this._i.SetContentColor(rowTypes,pColor._i);
		//}
		...
		/////
		/////</summary>
		//public object GetGridLineWeight(OdaX.AcGridLineType gridLineType,OdaX.AcRowType rowType) 
		//{
		...
		/////
		/////</summary>
		//public void SetGridColor(int gridLineTypes,int rowTypes, AcadAcCmColor pColor) 
		//{
		//	this._i.SetGridColor(gridLineTypes,rowTypes,pColor._i);
		//}
		...
		///
		///</summary>
		public object GetCellType(int row, int col)
		{
		...
		///
		///</summary>
		public void SetCellType(int row, int col, OdaX.AcCellType CellType)
		{
		...
		/////
		/////</summary>
		//public object GetCellAlignment(int row,int col) 
		//{
		...
		/////
		/////</summary>
		//public void SetCellAlignment(int row,int col,OdaX.AcCellAlignment cellAlignment) 
		//{
		...
		/////
		/////</summary>
		//public AcadAcCmColor GetCellBackgroundColor(int row,int col) 
		//{
		//	return new AcadAcCmColor(this._i.GetCellBackgroundColor(row,col));
		//}

		/////<summary>
		/////
		/////</summary>
		//public void SetCellBackgroundColor(int row,int col, AcadAcCmColor pColor) 
		//{
		//	this._i.SetCellBackgroundColor(row,col,pColor._i);
		//}

		/////<summary>
		/////
		/////</summary>
		//public AcadAcCmColor GetCellContentColor(int row,int col) 
		//{
		//	return new AcadAcCmColor(this._i.GetCellContentColor(row,col));
		//}

		/////<summary>
		/////
		/////</summary>
		//public void SetCellContentColor(int row,int col, AcadAcCmColor pColor) 
		//{
		//	this._i.SetCellContentColor(row,col, pColor._i);
		//}
		...
		///
		///</summary>
		public object GetTextRotation(int row, int col)
		{
		...
		///
		///</summary>
		public void SetTextRotation(int row, int col, OdaX.AcRotationAngle TextRotation)
		{
		...
		/////
		/////</summary>
		//public long GetBlockTableRecordId(int row,int col) 
		//{
		...
		/////
		/////</summary>
		//public void SetBlockTableRecordId(int row,int col, long blkId,bool bAutoFit) 
		//{
		...
		/////
		/////</summary>
		//public string GetBlockAttributeValue(int row,int col,long attdefId) 
		//{
		...
		/////
		/////</summary>
		//public void SetBlockAttributeValue(int row,int col,long attdefId,string bstrValue) 
		//{
		...
		/////
		/////</summary>
		//public object GetCellGridLineWeight(int row,int col,OdaX.AcCellEdgeMask edge) 
		//{
		...
		///////
		///////</summary>
		////public void SetCellGridLineWeight(int row,int col,int edges, object Lineweight) 
		////{
		...
		/////
		/////</summary>
		//public AcadAcCmColor GetCellGridColor(int row,int col,OdaX.AcCellEdgeMask edge) 
		//{
		//	return new AcadAcCmColor(this._i.GetCellGridColor(row,col,edge));
		//}

		/////<summary>
		/////
		/////</summary>
		//public void SetCellGridColor(int row,int col,int edges, AcadAcCmColor pColor) 
		//{
		//	this._i.SetCellGridColor(row,col,edges,pColor._i);
		//}

		/////<summary>
		/////
		/////</summary>
		//public bool GetCellGridVisibility(int row,int col,OdaX.AcCellEdgeMask edge) 
		//{
		...
		/////
		/////</summary>
		//public long GetFieldId(int row,int col) 
		//{
		...
		/////
		/////</summary>
		//public void SetFieldId(int row,int col,long fieldId) 
		//{
		...
		/////
		/////</summary>
		//public void SetDataType(int rowTypes,OdaX.AcValueDataType dataType,OdaX.AcValueUnitType unitType) 
		//{
		...
		/////
		/////</summary>
		//public string FormatValue(int row,int col, OdaX.AcFormatOption option, string current_value) 
		//{
		...
		/////
		/////</summary>
		//public void SetCellDataType(int row,int col, OdaX.AcValueDataType dataType, OdaX.AcValueUnitType unitType) 
		//{
		...
		/////
		/////</summary>
		//public void SetCellValueFromText(int row,int col,string val,OdaX.AcParseOption nOption) 
		//{
		...
		/////
		/////</summary>
		//public void SetValueFromText(int nRow,int nCol,int nContent,string szText,OdaX.AcParseOption nOption) 
		//{
		...
		/////
		/////</summary>
		//public long GetFieldId2(int nRow,int nCol,int nContent) 
		//{
		...
		/////
		/////</summary>
		//public void SetFieldId2(int nRow,int nCol,int nContent,long acDbObjectId,OdaX.AcCellOption nflag) 
		//{
		...
		/////
		/////</summary>
		//public long GetBlockTableRecordId2(int nRow,int nCol,int nContent) 
		//{
		...
		/////
		/////</summary>
		//public void SetBlockTableRecordId2(int nRow,int nCol,int nContent,long blkId,bool autoFit) 
		//{
		...
		/////
		/////</summary>
		//public string GetBlockAttributeValue2(int nRow,int nCol,int nContent, long blkId) 
		//{
		...
		/////
		/////</summary>
		//public void SetBlockAttributeValue2(int nRow,int nCol,int nContent, long blkId,string Value) 
		//{
		...
		/////
		/////</summary>
		//public AcadAcCmColor GetContentColor2(int nRow,int nCol,int nContent) 
		//{
		//	return new AcadAcCmColor(this._i.GetContentColor2(nRow,nCol,nContent));
		//}

		/////<summary>
		/////
		/////</summary>
		//public void SetContentColor2(int nRow,int nCol,int nContent, AcadAcCmColor pColor) 
		//{
		//	this._i.SetContentColor2(nRow,nCol,nContent,pColor._i);
		//}
		...
		///
		///</summary>
		public long GetGridLinetype(int nRow, int nCol, OdaX.AcGridLineType nGridLineType)
		{
		...
		///
		///</summary>
		public void SetGridLinetype(int nRow, int nCol, OdaX.AcGridLineType nGridLineType, long idLinetype)
		{
		...
		/////
		/////</summary>
		//public double GetGridDoubleLineSpacing(int nRow,int nCol,OdaX.AcGridLineType nGridLineType) 
		//{
		...
		/////
		/////</summary>
		//public void SetGridDoubleLineSpacing(int nRow,int nCol,OdaX.AcGridLineType nGridLineType,double fSpacing) 
		//{
		...
		/////
		/////</summary>
		//public object GetContentType(int nRow,int nCol) 
		//{
		...
		///
		///</summary>
		public double GetMargin(int nRow, int nCol, OdaX.AcCellMargin nMargin)
		{
		...
		///
		///</summary>
		public void SetMargin(int nRow, int nCol, OdaX.AcCellMargin nMargins, double fMargin)
		{
		...
		/////
		/////</summary>
		//public object GetContentLayout(int row,int col) 
		//{
		...
		/////
		/////</summary>
		//public void SetContentLayout(int row,int col,OdaX.AcCellContentLayout nLayout) 
		//{
		...
		/////
		/////</summary>
		//public object GetOverride(int nRow,int nCol,int nContent) 
		//{
		...
		/////
		/////</summary>
		//public void SetOverride(int nRow,int nCol,int nContent,OdaX.AcCellProperty nProp) 
		//{
		...
		/////
		/////</summary>
		//public object GetGridLineStyle(int nRow,int nCol,OdaX.AcGridLineType nGridLineType) 
		//{
		...
		/////
		/////</summary>
		//public void SetGridLineStyle(int nRow,int nCol,OdaX.AcGridLineType nGridLineTypes,OdaX.AcGridLineStyle nLineStyle) 
		//{
		...
		/////
		/////</summary>
		//public object GetCellState(int nRow,int nCol) 
		//{
		...
		/////
		/////</summary>
		//public void SetCellState(int nRow,int nCol,OdaX.AcCellState nLock) 
		//{
		...
		/////
		/////</summary>
		//public object TableBreakFlowDirection => this._i.TableBreakFlowDirection;

		/////<summary>
		/////
		/////</summary>
		//public void Set_TableBreakFlowDirection(OdaX.AcTableFlowDirection pDir) 
		//{
