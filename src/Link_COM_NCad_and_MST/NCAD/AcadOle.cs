...
namespace DynNCXLib 
{
    ...
    public class AcadOle 
	{
		...
		{
			this._i = AcadOle_object as OdaX.IAcadOle;
        ...
        {
            this._i = AcadEntity._i as OdaX.IAcadOle;
            if (this._i == null) throw new System.Exception("Invalid casting");
        }
        ///<summary>
        ///
        ...
        /// Specifies whether the OLE object is linked to the original pasted file when opening the object for editing
        ///</summary>
        public void Set_OleItemType(OdaX.AcOleType pType) 
		{
        ...
        /// Controls the plot quality of an OLE object based on the file type selected from the list
        ///</summary>
        public void Set_OlePlotQuality(OdaX.AcOlePlotQuality pPQuality) 
		{
