namespace DynNCXLib 
{
	...
	{
		public OdaX.AcadMLeaderStyle _i;
		internal AcadMLeaderStyle(object AcadMLeaderStyle_object) 
		{
			this._i = AcadMLeaderStyle_object as OdaX.AcadMLeaderStyle;
		...
		///
		///</summary>
		public void Set_DrawMLeaderOrderType(OdaX.AcDrawMLeaderOrderType Type) 
		{
		...
		///
		///</summary>
		public void Set_DrawLeaderOrderType(OdaX.AcDrawLeaderOrderType Type) 
		{
		...
		///
		///</summary>
		public void Set_FirstSegmentAngleConstraint(OdaX.AcSegmentAngleType constraint) 
		{
		...
		///
		///</summary>
		public void Set_SecondSegmentAngleConstraint(OdaX.AcSegmentAngleType constraint) 
		{
		...
		///
		///</summary>
		public void Set_LeaderLinetype(OdaX.AcMLeaderType Type) 
		{
		...
		///
		///</summary>
		public void Set_LeaderLineWeight(OdaX.AcLineWeight weight) 
		{
		...
		///
		///</summary>
		public void Set_TextAngleType(OdaX.AcTextAngleType Type) 
		{
		...
		///
		///</summary>
		public void Set_TextAlignmentType(OdaX.AcTextAlignmentType Type) 
		{
