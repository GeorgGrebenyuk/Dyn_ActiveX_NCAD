namespace DynNCXLib 
{
	...
	{
		public OdaX.AcadSectionTypeSettings _i;
		internal AcadSectionTypeSettings(object AcadSectionTypeSettings_object) 
		{
			this._i = AcadSectionTypeSettings_object as OdaX.AcadSectionTypeSettings;
		...
		///
		///</summary>
		public void Set_GenerationOptions(OdaX.AcSectionGeneration pVal) 
		{
		...
		///
		///</summary>
		public void Set_IntersectionFillHatchPatternType(OdaX.AcPatternType pVal) 
		{
