...
namespace DynNCXLib 
{
    ...
    public class AcadEntity 
	{
		...
		{
			this._i = AcadEntity_object as OdaX.AcadEntity;
        ...
        public static AcadEntity ByAnyObject (dynamic AnyModelObject)
		{
			try
			{
				var casted_interface = AnyModelObject._i as OdaX.AcadEntity;
        ...
        public object IntersectWith(AcadEntity IntersectObject, OdaX.AcExtendOption option)
		{
		...
		{
			this._i.Lineweight = (OdaX.ACAD_LWEIGHT)Lineweight;
		}
  ...
  //      public void Set_EntityTransparency(string transparency)
		...
		{
			this._i.color = (OdaX.ACAD_COLOR)color;
		}
	}
}
