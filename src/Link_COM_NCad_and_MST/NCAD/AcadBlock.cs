...
namespace DynNCXLib 
{
    ...
    public class AcadBlock 
	{
		...
		{
			this._i = AcadBlock_object as OdaX.AcadBlock;
        ...
        {
           this._i = (OdaX.AcadBlock)AcadBlocks._i.Add(Technical.PointByDynPoint(InsertionPoint), Name);
        }
        ///<summary>
        ...
        ///Specifies the native units of measure for the block
        ///</summary>
        public void Set_Units(OdaX.AcInsertUnits pIU)
		{
			this._i.Units = pIU;
		}
        ...
        ///Specifies the scaling allowed for the block
        ///</summary>
        public void Set_BlockScaling(OdaX.AcBlockScaling pBS)
		{
