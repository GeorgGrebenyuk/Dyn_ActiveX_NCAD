...
namespace DynNCXLib
{
    ...
    {
        public nanoCAD.SelectionSet _i;
        internal SelectionSet(object AcadSelectionSet_object)
        {
            this._i = AcadSelectionSet_object as nanoCAD.SelectionSet;
        }
        /// <summary>
        ...
        public SelectionSet(SelectionSets AcadSelectionSets, string Name)
        {
            for (int i = 0; i < AcadSelectionSets._i.Count; i++)
            {
                var obj = AcadSelectionSets._i[i];
        ...
        public static void Select(dynamic AcadSelectionSet, OdaX.AcSelect acSelect, Point Point1, Point Point2, 
        ...
        {
            AcadSelectionSet._i.Select(OdaX.AcSelect.acSelectionSetAll);
        }
        ...
        /// <param name="FilterType">A DXF group code specifying the type of filter to use</param>
        /// <param name="FilterData">The value to filter on</param>
        public static void SelectByPolygon(dynamic AcadSelectionSet, OdaX.AcSelect acSelect, List<Point> points, object FilterType, object FilterData)
        {
