...
namespace DynNCXLib 
{
	...
	{
		public OdaX.AcadSection _i;
		internal AcadSection(object AcadSection_object) 
		{
			this._i = AcadSection_object as OdaX.AcadSection;
        ...
        {
            this._i = AcadEntity._i as OdaX.AcadSection;
            if (this._i == null) throw new System.Exception("Invalid casting");
        }
        ...
        {
            this._i =(OdaX.AcadSection)AcadBlock._i.AddSection(
		...
		///
		///</summary>
		public void Set_State(OdaX.AcSectionState pVal) 
		{
			this._i.State = pVal;
		}
		...
		public List<object> HitTest(object varPtHit)
        {
			...
			int pSegmentIndex;
			object pPtOnSegment;
			OdaX.AcSectionSubItem pSubItem;
