...
namespace DynNCXLib 
{
	...
	{
		public OdaX.AcadPolyfaceMesh _i;
		internal AcadPolyfaceMesh(object AcadPolyfaceMesh_object) 
		{
			this._i = AcadPolyfaceMesh_object as OdaX.AcadPolyfaceMesh;
        ...
        {
            this._i = AcadEntity._i as OdaX.AcadPolyfaceMesh;
            if (this._i == null) throw new System.Exception("Invalid casting");
        }
        ...
        {
            this._i =  (OdaX.AcadPolyfaceMesh)AcadBlock._i.AddPolyfaceMesh(VertexList.Select(p=>Technical.PointByDynPoint(p)), 
