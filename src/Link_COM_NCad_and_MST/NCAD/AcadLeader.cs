...
namespace DynNCXLib 
{
	...
	{
		public OdaX.AcadLeader _i;
		internal AcadLeader(object AcadLeader_object) 
		{
			this._i = AcadLeader_object as OdaX.AcadLeader;
		...
		{
			this._i = AcadEntity._i as OdaX.AcadLeader;
			if (this._i == null) throw new System.Exception("Invalid casting");
		}
        /// <summary>
        ...
        public AcadLeader (AcadBlock AcadBlock, List<Point> PointsArray, 
			OdaX.AcLeaderType Type, AcadEntity Annotation)
        {
		...
		///
		///</summary>
		public void Set_Type(OdaX.AcLeaderType Type) 
		{
			this._i.Type = Type;
		}
