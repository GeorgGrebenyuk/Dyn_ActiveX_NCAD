...
namespace DynNCXLib 
{
	...
	{
		public OdaX.Acad3DSolid _i;
		internal Acad3DSolid(object Acad3DSolid_object) 
		{
			this._i = Acad3DSolid_object as OdaX.Acad3DSolid;
		...
		{
			this._i = AcadEntity._i as OdaX.Acad3DSolid;
			if (this._i == null) throw new System.Exception("Invalid casting");
		}
        ...
        public Acad3DSolid CheckInterference(dynamic Object,bool CreateInterferenceSolid) 
		{
			...
			var data = this._i.CheckInterference(Object._i, CreateInterferenceSolid);
